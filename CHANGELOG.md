...
| 6 | Обработка ошибок `strtoul` | Рекомендуемый | ✅ Добавлено |
| 7 | Разделение `main()` на функции | Рекомендуемый | ✅ Добавлено |
| 8 | Логирование с уровнями | Дополнительно | ✅ Добавлено |
| 9 | Валидация `iface` | Дополнительно | ✅ Добавлено |
| 10 | Обработка `EINTR` | Дополнительно | ✅ Добавлено |
| 11 | Документация структур | Дополнительно | ✅ Добавлено |
